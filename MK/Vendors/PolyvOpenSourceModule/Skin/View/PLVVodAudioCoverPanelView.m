...
- (void)setCoverUrl:(NSString *)url {
    [self.audioCoverContainerBackgroundImageView sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:nil];
    [self.audioCoverImage sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:nil];
}
