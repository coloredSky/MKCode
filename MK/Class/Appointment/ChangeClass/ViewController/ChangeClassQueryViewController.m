//
//  ChangeClassQueryViewController.m
//  MK
//
...
@implementation ChangeClassQueryViewController
...
//        _headerView.titleString = @"等待回复";
        ...
        _headerView.showType = self.checkType == ChangeClassQueryCheckTypeCanEdit ? AppointmentHeaderViewShowTypeEditting : AppointmentHeaderViewShowTypeNormal;
